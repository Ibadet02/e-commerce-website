...
export const MobileNavbar = ({isMobileNavOpen, setIsMobileNavOpen, darkMode, setDarkMode}: MobileNavbarProps) => {
  return (
    <div
    className={`mobile-navbar ${darkMode && 'dark'} ${isMobileNavOpen && 'active'}`}>
        <div className='mobile-navbar__flex'>
          <div className="mobile-tools">
            <div className="mobile-tools--top">
            ...
            <div className="mobile-search">
              <input placeholder='Search...' type="text" className="mobile-search__input" />
                <div>
                  <svg className='mobile-search__icon' width="1em" height="1.0625em" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
